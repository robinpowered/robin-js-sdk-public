...
Channels = (function () {
  ...
  Channels.prototype.addTrigger = function (channelId, triggerData) {
    if (channelId && triggerData) {
      ...
      return this.rejectRequest('Bad Request. Channel id and trigger data must be supplied.');
    }
  };
  ...
  Channels.prototype.getTrigger = function(channelId, triggerId) {
    if (channelId && triggerId) {
      ...
      return this.rejectRequest('Bad Request. Channel id and trigger id must be supplied.');
    }
  };
