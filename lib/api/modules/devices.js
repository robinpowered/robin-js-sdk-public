  ...
  identifiers: {
    ...
    get: function (deviceIdentifier, identifierURN, params) {
      ...
      if (deviceIdentifier) {
        ...
        this.rejectRequest('Bad Request: A device identifier is required.');
      }
    },
    ...
    create: function (deviceIdentifier, data) {
      ...
      if (deviceIdentifier) {
        ...
        this.rejectRequest('Bad Request: A device identifier and a data object are required.');
      }
    },
    ...
    add: function (deviceIdentifier, identifierUrn, data) {
      ...
      if (deviceIdentifier) {
        ...
        this.rejectRequest('Bad Request: A device identifier, an identifier id and a data object are required.');
      }
    },
    ...
    delete: function (deviceIdentifier, identifierUrn) {
      ...
      if (deviceIdentifier && identifierUrn) {
        ...
        this.rejectRequest('Bad Request: A device identifier and an identifier id are required.');
      }
    }
  },
  ...
  channels: {
    ...
    update: function (deviceIdentifier, channelIdentifier, data) {
      ...
      if (deviceIdentifier && channelIdentifier && data) {
        ...
        this.rejectRequest('Bad Request: A device identifier, a feed identifier and a data object are required.');
      }
    },
    ...
    delete: function (deviceIdentifier, channelIdentifier) {
      ...
      if (deviceIdentifier && channelIdentifier) {
        ...
        this.rejectRequest('Bad Request: A device identifier and a channel identifier are required.');
      }
    }
  }
};
