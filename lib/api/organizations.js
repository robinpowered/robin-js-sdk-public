...
Organizations = (function () {
  ...
  Organizations.prototype.createOrganization = function (params) {
    ...
    if (params && params.data) {
      this._robin.sendRequest('/organizations', 'POST', d, params.data)
    } else {
  ...
  Organizations.prototype.updateOrganization = function (params) {
    ...
    if (params && params.id && params.data) {
      this._robin.sendRequest('/organizations/' + params.id, 'PATCH', d, params.data)
    } else {
  ...
  Organizations.prototype.getUserOrganizations = function () {
    var d = q.defer();
    this._robin.sendRequest('/me/organizations/', 'GET', d);
    return d.promise;
  },
  ...
  Organizations.prototype.getOrganization = function (params) {
    var d = q.defer();
    if (params && params.id) {
      this._robin.sendRequest('/organizations/' + params.id, 'GET', d);
    } else {
  ...
  Organizations.prototype.getOrganizationUsers = function (params) {
    var d = q.defer();
    if (params && params.id) {
      this._robin.sendRequest('/organizations/' + params.id + '/users', 'GET', d)
    } else {
      d.reject('Bad Request. An id must be supplied in params object.');
    }
    return d.promise;
  ...
  Organizations.prototype.getOrganizationUser = function (params) {
    ...
    if (params && params.id && params.userId) {
      this._robin.sendRequest('/organizations/' + params.id + '/users/' + params.userId, 'GET', d)
    } else {
  ...
  Organizations.prototype.addUser = function (params) {
    var d = q.defer();
    if (params && params.id && params.userId) {
      this._robin.sendRequest('/organizations/' + params.id + '/users/' + params.userId, 'PUT', d)
    } else {
      d.reject('Bad Request. An id and userId must be supplied in params object.');
    }
    return d.promise;
  ...
  Organizations.prototype.removeUser = function (params) {
    var d = q.defer();
    if (params && params.id && params.userId) {
      this._robin.sendRequest('/organizations/' + params.id + '/users/' + params.userId, 'DELETE', d)
    } else {
      d.reject('Bad Request. An id and userId must be supplied in params object.');
    }
    return d.promise;
