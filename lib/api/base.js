...
RobinApiBase = (function () {
  ...
  _RobinGridBase.prototype.setCoreUrl = function (baseUrl) {
    if (baseUrl) {
      this.baseUrl = baseUrl;
    }
  };

  _RobinGridBase.prototype.getCoreUrl = function () {
    if (this._gridUrl) {
      return this._gridUrl;
    }
  };

  _RobinGridBase.prototype.setPlacesUrl = function (placesApiBaseUrl) {
    if (placesApiBaseUrl) {
      this.placesApiBaseUrl = placesApiBaseUrl;
    }
  };

  _RobinGridBase.prototype.getPlacesUrl = function () {
