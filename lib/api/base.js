...
RobinApiBase = (function () {
  ...
  _RobinApiBase.prototype.sendRequest = function(endpoint, method, json, queryStringObj, usePlacesAPI) {
    ...
    this.makeRequest(options, deferred);
    return deferred.promise;
  };

  _RobinApiBase.prototype.makeRequest = function (options, deferred) {
    var self = this;
    if (!options) {
      throw new Error('The options payload argument is required');
    }
    if (!deferred) {
      throw new Error('The deferred object argument is required');
    }
