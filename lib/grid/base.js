...
RobinGridBase = (function (_super) {
  ...
  _RobinGridBase.prototype.setDeviceIdentifier = function(deviceIdentifier) {
    if (deviceIdentifier) {
      this._deviceIdentifier = deviceIdentifier;
    }
  };

  _RobinGridBase.prototype.getDeviceIdentifier = function() {
  ...
  _RobinGridBase.prototype.setupFayeClient = function (clientCallback) {
    var _grid = this,
        ...
        _deviceIdentifier = this.getDeviceIdentifier();
    ...
    if (this._baseUrl) {
      ...
      this.fayeClient.addExtension({
        outgoing: function (message, callback) {
          ...
          message.ext.deviceIdentifier = _deviceIdentifier;
          callback(message);
        }
      });
    }
